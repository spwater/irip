...
export type JobDetail = { id: string; kind: string; status: string; stage: string; progress: number; retryable: boolean; attempt: number; max_attempts: number; created_at: string; updated_at: string; created_by: string | null; last_error: Record<string, unknown> | null; result: Record<string, unknown> | null; payload: Record<string, unknown> | null; };
