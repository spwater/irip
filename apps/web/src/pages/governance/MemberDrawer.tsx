    ...
    mutationFn: async (user: DepartmentUser) => {
      ...
      const primaryId =
        primaryDep && primaryDep.department_id !== department.id
          ...
          : undefined;
      return apiSetUserDepartments(user.user_id, {
